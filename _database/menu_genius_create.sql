...
-- Last modification date: 2023-10-27 19:56:08.302
...
CREATE TABLE Alapanyag (
    ...
    CONSTRAINT Alapanyag_ID PRIMARY KEY (ID)
);
...
CREATE TABLE alapanyag_allergen (
    ...
    CONSTRAINT alapanyag_allergen_ID PRIMARY KEY (Alapanyag_ID,Allergen_ID)
);
...
CREATE TABLE Kategoria (
    ...
    CONSTRAINT Kategoria_ID PRIMARY KEY (ID)
);
...
CREATE TABLE Tetel (
    ...
    CONSTRAINT Tetel_ID PRIMARY KEY (ID)
);
...
CREATE TABLE tetel_alapanyag (
    ...
    FOREIGN KEY (Alapanyag_ID) REFERENCES Alapanyag(ID),
    CONSTRAINT tetel_alapanyag_ID PRIMARY KEY (Alapanyag_ID,Tetel_ID)
);
...
CREATE TABLE Asztal (
    ...
    CONSTRAINT Asztal_ID PRIMARY KEY (ID)
);
...
CREATE TABLE Foglalas (
    ...
    CONSTRAINT Foglalas_ID PRIMARY KEY (ID)
);
...
CREATE TABLE Rendeles (
    ...
    FOREIGN KEY (Asztal_ID) REFERENCES Asztal(ID),
    CONSTRAINT Rendeles_ID PRIMARY KEY (ID)
);
...
CREATE TABLE tetel_rendeles (
    ...
    db int  NOT NULL,
    CONSTRAINT tetel_rendeles_ID PRIMARY KEY (ID)
);
